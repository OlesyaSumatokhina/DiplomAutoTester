...
class TestPayMyPayment {
 ...
 //   @Test
   // @DisplayName("Оплата по одобренной карте, обычная покупка, валидные данные")
 ...
 //   @Test
  //  @DisplayName("Оплата по неодобренной карте, обычная покупка с валидными данными")
  ...
  //  @Test
  //    @DisplayName("Оплата по неизвестной карте, обычная покупка с валидными данными")
